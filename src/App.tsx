          ...
          <Toolbar>
            <Grid justify="space-between" alignItems="center" alignContent="center" container>
              ...
              <Grid item>
                ...
                />
                <LanguageMenu />
                <Tooltip title={t("Parsiq ") as string}>
                  <IconButton
                    onClick={() =>
                      window.open("https://www.parsiq.net/en/") //tslint:disable-line
                    }>
                    <NotesIcon />
                  </IconButton>
                </Tooltip>
                <Tooltip title={t("Code Samples") as string}>
                  <IconButton
                    onClick={() =>
                      window.open("https://docs.parsiq.net/parsiql/code-samples")
                    }>
                    <CodeIcon />
                  </IconButton>
                </Tooltip>
